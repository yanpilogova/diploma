...
public class CreditPage {
    ...
    public void fillCreditPaymentFormat(DataHelper.CardNumber info, String month, String year, String owner, String cvc) {
    ...
    public void checkSuccessCreditNotification() {
        successNotification.shouldBe(Condition.visible, Duration.ofSeconds(15));
    }

    public void checkErrorCreditNotification() {
        errorNotification.shouldBe(Condition.visible, Duration.ofSeconds(15));
    }

    public void checkWrongCreditFormat() {
        wrongFormat.shouldBe(Condition.visible);
    }

    public void checkInvalidCreditCardExpirationDate() {
        invalidCardExpirationDate.shouldBe(Condition.visible);
    }

    public void verifyCreditCardExpired() {
        cardExpired.shouldBe(Condition.visible);
    }

    public void verifyCreditEmptyField() {
